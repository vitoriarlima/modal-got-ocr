  ...
  return (
    <div className="min-h-screen bg-black text-white font-inter">
        ...
        <div className="max-w-6xl mx-auto mb-8">
          <div className="bg-[#212525] rounded-3xl p-4">
            <div className="flex items-center space-x-2 px-4">
              <img 
                src="images/modal_cute_1.svg" 
                alt="Modal Icon" 
                className="w-13 h-12"
              />
              <span className="text-[#80ee64] font-extralight text-[20px]">Image to Text - GOT OCR 2.0</span>
            </div>
          </div>
        </div>

        <h1 className="text-4xl text-center text-[#deffdc] py-8 font-light">Image to Text Converter</h1>
          ...
          <div className="bg-[#212525] rounded-3xl p-8">
              ...
              <div className="bg-[#deffdc] rounded-lg p-6 min-h-[400px] relative">
                ...
                <div className="bg-[#f0f0f0] rounded-lg p-4 h-full transform scale-90 overflow-auto">
                  {isLoading ? (
                    ...
                    <span className="text-black">Extracted text will appear here...</span>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <a
                ...
                //  Easter Egg
                //  href="https://www.youtube.com/watch?v=nI6GP8wKJ6o&list=PLxA687tYuMWhCPUY91XZo1tCPYP3359VP"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#80ee64] text-black px-4 py-1 rounded-full font-arial text-sm hover:opacity-90 transition-opacity"
              >
                I'm feeling lucky ✨
              </a>
            </div>
      ...
      <footer className="fixed bottom-0 w-full bg-[#212525] py-6">
        <div className="flex items-center justify-end space-x-2 text-gray-400 px-8">
          <span>Powered by</span>
          <img 
            src="images/modal_logo_2.png" 
            alt="Modal Logo" 
